    ...
    sections: [
      ...
      },
      {
        ...
        fields: [
          ...
          { name: 'bookingUrl', label: 'Book-an-appointment link (optional)', type: 'text', wide: true,
            placeholder: 'https://mobapp.kinderhospitals.com',
            hint: 'Where this hospital’s “Book Appointment” buttons go. Leave empty to use the group WhatsApp booking.' },
          ORDER,
        ],
      },
      VISIBILITY,
