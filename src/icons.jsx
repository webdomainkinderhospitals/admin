...
// Single-source SVG icon set (Lucide-style, 1.75px stroke) so the whole
// portal shares one visual language instead of platform-dependent emojis.
const PATHS = {
  dashboard: (
    <>
  ...
  building: (
    <>
      ...
      <path d="M9 21v-4h6v4" />
      <path d="M10 9h1m2 0h1m-4 4h1m2 0h1" />
    </>
  ),
  doctor: (
    <>
  ...
  news: (
    <>
      ...
      <path d="M18 14h-8m8-4h-8m4 8h-4" />
    </>
  ),
